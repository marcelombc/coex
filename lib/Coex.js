	    ...
	    _createClass(Coex, [{
	        ...
	        value: function _handleImageLoad() {
	            ...
	            if (typeof Worker !== 'undefined') {
	                if (!Coex._worker) {
	                    Coex._worker = new _worker2.default();
	                }
	        ...
	        value: function _handleWorkerMessage(e) {
	        ...
	        key: '_handleWorkerError',
	        value: function _handleWorkerError() {
	            Coex._worker.removeEventListener('message', this._handleWorkerMessage);
	            Coex._worker.removeEventListener('error', this._handleWorkerError);
	            this._workerFallback();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		return new Worker(__webpack_require__.p + "cbd3a786ece3a7d43b55.worker.js");
	};
